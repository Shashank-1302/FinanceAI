      ...
      case 1:
        return (
          <VStack spacing={4} align="stretch">
            ...
            <FormControl>
              <FormLabel htmlFor="annualIncome">Annual Income (INR):</FormLabel>
              <InputGroup>
          ...
          <VStack spacing={4} align="stretch">
            ...
            {Object.entries(formData.monthlyExpenses).map(([category, value]) => (
              <FormControl key={category}>
                <FormLabel htmlFor={category}>{category.charAt(0).toUpperCase() + category.slice(1)} (INR):</FormLabel>
                <InputGroup>
                  <InputLeftAddon children="₹" />
                  <Input
                    type="number"
      ...
      case 3:
        return (
          <VStack spacing={4} align="stretch">
            ...
            <FormControl>
              <FormLabel htmlFor="currentSavings">Current Savings (INR):</FormLabel>
              <InputGroup>
                <InputLeftAddon children="₹" />
                <Input
                  type="number"
  ...
  return (
    <Container maxW="container.md" py={10}>
      <VStack spacing={8} align="stretch">
        ...
        <Text>Help us understand your financial situation to provide personalized advice. All amounts are in INR.</Text>
